...
const product = {
    ...
    images: [
        {
            src: 'https://i.ibb.co/qkPwmqv/palm-3.jpg',
            alt: 'Two each of gray, white, and black shirts laying flat.',
        },
        {
            src: 'https://i.ibb.co/X8Q0pcB/palm-2.jpg',
            alt: 'Model wearing plain gray basic tee.',
        },
        {
            src: 'https://i.ibb.co/R9HxYV5/palm-1.jpg',
            alt: 'Model wearing plain white basic tee.',
        },
        {
            src: 'https://i.ibb.co/ZmJwLF0/palm-4.jpg',
    ...
    description:
        ...
        ' ใกล้สนามบินหัวหิน' +
        ' ใกล้โรงพยาบาลหัวหิน' +
        ' ใกล้แมคโครซุปเปอร์สโตร์' +
        ' ️ใกล้แหล่งท่องเที่ยวยอดนิยมในหัวหิน-ชะอำ'
    ,
    highlights: [
        'Brand new Luxury Villa For Sale Hua Hin - Cha am⚡️Selling Price Start 14.8 - 15.4 MB.⛱️🔥 The Villa is situated in PalmHIills Golf Club & Residence' +
        ' Prime Location / only 5 minutes to beach and Airport ',
